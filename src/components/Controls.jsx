...
import { RotateIcon, ArrowLeftIcon, ArrowDownIcon, ArrowRightIcon, HardDropIcon, HoldIcon } from './Icons';
...
const Controls = ({ onMove, onRotate, onHardDrop, onPause, onHold, isPaused, gameOver, canHold }) => {
 ...
 className="bg-blue-500 text-white p-4 rounded-full shadow-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
 >
 <RotateIcon size={24} />
 </motion.button>
 <div></div>
 ...
 className="bg-gray-600 text-white p-4 rounded-full shadow-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
 >
 ...
 className="bg-red-500 text-white p-4 rounded-full shadow-lg hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
 >
 <HardDropIcon size={24} />
 </motion.button>
