...
const MEDAL_COMPONENTS = {
 ...
 2: <MedalSilverIcon size={24} />,
 3: <MedalBronzeIcon size={24} />
};
...
function LeaderboardPanel({ onClose }) {
 ...
 const itemCount = tabs.length + (hasRefresh ? 1 : 0) + 1;
 ...
 <td className="p-3">
 <div className="flex items-center gap-2">
 {MEDAL_COMPONENTS[actualRank] ? (
 <span>{MEDAL_COMPONENTS[actualRank]}</span>
 ) : (
