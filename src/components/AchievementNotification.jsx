...
import { MedalBronzeIcon, MedalSilverIcon, MedalGoldIcon, MedalPlatinumIcon, CoinIcon } from './Icons';
...
function AchievementNotification() {
 ...
 const tierEmojis = {
 bronze: <MedalBronzeIcon size={40} />,
 silver: <MedalSilverIcon size={40} />,
 gold: <MedalGoldIcon size={40} />,
 platinum: <MedalPlatinumIcon size={40} />
 };
 ...
 <CoinIcon size={18} className="text-yellow-400" />
