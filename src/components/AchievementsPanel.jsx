...
import { CloseIcon, MedalBronzeIcon, MedalSilverIcon, MedalGoldIcon, MedalPlatinumIcon, CheckIcon, MEDAL_ICONS } from './Icons';
...
function AchievementsPanel({ onClose }) {
 ...
 const tierEmojis = {
 bronze: <MedalBronzeIcon size={32} />,
 silver: <MedalSilverIcon size={32} />,
 gold: <MedalGoldIcon size={32} />,
 platinum: <MedalPlatinumIcon size={32} />
 };
 ...
 <div className="text-center">
 <div className="flex justify-center"><MedalBronzeIcon size={24} /></div>
 <div className="text-white/80 text-sm">{stats.byTier.bronze}</div>
 </div>
 <div className="text-center">
 <div className="flex justify-center"><MedalSilverIcon size={24} /></div>
 <div className="text-white/80 text-sm">{stats.byTier.silver}</div>
 </div>
 <div className="text-center">
 <div className="flex justify-center"><MedalGoldIcon size={24} /></div>
 <div className="text-white/80 text-sm">{stats.byTier.gold}</div>
 </div>
 <div className="text-center">
 <div className="flex justify-center"><MedalPlatinumIcon size={24} /></div>
 ...
 <img src={globalAssets.achievementsPanel.emptyState} alt="" className="w-20 h-20 object-contain opacity-60" aria-hidden="true" />
