...
export default function TSpinShowcase({ onClose }) {
 ...
 <div className="flex items-center gap-2 w-full max-w-xl mb-3 relative z-10">
 <motion.button
 ...
 <h1 className="text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 tracking-tight">
