...
function TutorialHub({ tutorialService, onClose, onLessonComplete }) {
 ...
 const modules = [
 { key: 'fundamentals', icon: 'I', name: t('tutorial.fundamentals'), desc: t('tutorial.fundamentalsDesc') },
 { key: 'intermediate', icon: 'II', name: t('tutorial.intermediate'), desc: t('tutorial.intermediateDesc') },
 { key: 'advanced', icon: 'III', name: t('tutorial.advanced'), desc: t('tutorial.advancedDesc') },
 { key: 'pro', icon: 'IV', name: t('tutorial.pro'), desc: t('tutorial.proDesc') },
 ];
