...
function MultiplayerPanel({ onClose, onStartMatch }) {
 ...
 <span className="text-white">{mode.id === 'vs-ai' ? <SwordsIcon size={24} /> : <RobotIcon size={24} />}</span>
 ...
 <span className="text-white">{selectedMode.id === 'vs-ai' ? <SwordsIcon size={28} /> : <RobotIcon size={28} />}</span>
 <div>
 ...
 <span className="text-white">{(() => { const Icon = DIFFICULTY_ICONS[diff.id]; return Icon ? <Icon size={20} /> : null; })()}</span>
 <div>
 ...
 >
 <div className="flex items-center gap-2">
 <span className="text-white">{(() => { const Icon = DIFFICULTY_ICONS[diff.id]; return Icon ? <Icon size={18} /> : null; })()}</span>
