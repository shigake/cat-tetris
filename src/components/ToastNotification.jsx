...
import { SuccessCircleIcon, ErrorCircleIcon, WarningIcon, InfoCircleIcon } from './Icons';
...
function ToastNotification() {
 ...
 switch (type) {
 case 'success': return <SuccessCircleIcon size={20} />;
 case 'error': return <ErrorCircleIcon size={20} />;
 case 'warning': return <WarningIcon size={20} />;
 case 'info':
 default: return <InfoCircleIcon size={20} />;
 }
 };
