...
}, D = (s) => [d.prefix, s, d.suffix].filter((e) => e && e.length > 0).join("-"), X = (s) => {
...
class le {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), l = this.hasCallback("cacheDidUpdate"), g = l ? await re(
...
class I {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, r = new le(this, { event: t, request: n, params: a }), i = this._getResponse(r, n, t), c = this._awaitComplete(i, r, n, t);
    return [i, c];
  }
...
class he {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = Z(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
const $ = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function Te(s) {
...
function Ne(s) {
  return s === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return s.apply(T(this), e), f($.get(this));
  } : function(...e) {
    return f(s.apply(T(this), e));
  };
}
function Ie(s) {
  return typeof s == "function" ? Ne(s) : (s instanceof IDBTransaction && Pe(s), De(s, Le()) ? new Proxy(s, N) : s);
}
function f(s) {
  ...
  if (U.has(s))
    return U.get(s);
  const e = Ie(s);
  return e !== s && (U.set(s, e), M.set(e, s)), e;
}
const T = (s) => M.get(s);
function Me(s, e, { blocked: t, upgrade: n, blocking: a, terminated: r } = {}) {
...
const Ke = ["get", "getKey", "getAll", "getAllKeys", "count"], Oe = ["put", "add", "delete", "clear"], P = /* @__PURE__ */ new Map();
function W(s, e) {
  if (!(s instanceof IDBDatabase && !(e in s) && typeof e == "string"))
    return;
  if (P.get(e))
    return P.get(e);
  const t = e.replace(/FromIndex$/, ""), n = e !== t, a = Oe.includes(t);
  if (
...
const Se = "workbox-expiration", y = "cache-entries", B = (s) => {
...
class ve {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Me(Se, 1, {
...
class We {
   ...
   */
  constructor(e, t = {}) {
    this._isRunning = !1, this._rerunRequested = !1, this._maxEntries = t.maxEntries, this._maxAgeSeconds = t.maxAgeSeconds, this._matchOptions = t.matchOptions, this._cacheName = e, this._timestampModel = new ve(e);
  }
  /**
...
Ce([{"revision":null,"url":"assets/AIShowcase-a21cf09c.js"},{"revision":null,"url":"assets/CreatorMode-f32be36d.js"},{"revision":null,"url":"assets/GameModesPanel-40c51fe4.js"},{"revision":null,"url":"assets/index-10276b52.js"},{"revision":null,"url":"assets/index-3fc3c374.css"},{"revision":null,"url":"assets/MultiplayerGame-2e7c2864.js"},{"revision":null,"url":"assets/MultiplayerPanel-425b2aaf.js"},{"revision":null,"url":"assets/SettingsMenu-e0a53221.js"},{"revision":null,"url":"assets/ShopPanel-f4e8ed43.js"},{"revision":null,"url":"assets/TutorialHub-bc7bbe15.js"},{"revision":null,"url":"assets/workbox-window.prod.es5-5ffdab76.js"},{"revision":"d2d0e8649993e9c5adbc919638a6e1e7","url":"cat-icon.png"},{"revision":"51f9bd32f71834259f34e7e53589eacc","url":"cat-icon.svg"},{"revision":"a66ac393807730426893c47c2e0a14eb","url":"cats/btn-continuar.png"},{"revision":"7ab51b9cd1678c5a1d336191a9dd8793","url":"cats/btn-criador.png"},{"revision":"8af4e4de0a928bebbefce27480adbd69","url":"cats/btn-ia-expert.png"},{"revision":"f1e14f27b9a7f89ad2b2facbeb0e17b9","url":"cats/btn-loja.png"},{"revision":"68c72d78e6395ce56bfcd8e0a30e8f86","url":"cats/btn-novo-jogo.png"},{"revision":"0b63b08740b8360aca57e74fb34b8762","url":"cats/btn-tutorial-icon.png"},{"revision":"3e3080815383e5f626983d465d190250","url":"cats/btn-tutorial.png"},{"revision":"d740272f7ff35c2272292b377c0cdb7f","url":"cats/btn-vs-ia.png"},{"revision":"063d41f78cc0cb8b2423e9e965ab6046","url":"cats/paw-blue-disabled.png"},{"revision":"a4c6808d0f4e52fe6cad4621240ec574","url":"cats/paw-blue.png"},{"revision":"355c09d75c4e091f1c39bdd9831b42f2","url":"cats/paw-gold-lock.png"},{"revision":"3093719be9503f30e409d423065af560","url":"cats/paw-gold-special.png"},{"revision":"3096a788fb9837a341b7f5de60a39e4f","url":"cats/paw-gold.png"},{"revision":"a9eb0f7a453532a7c9625027ef18b35d","url":"cats/paw-green.png"},{"revision":"4788fdc69098b75436f5ceb768222d65","url":"cats/paw-purple-star.png"},{"revision":"611e59ed4001baf633cf8141a97c900b","url":"cats/paw-purple.png"},{"revision":"40630fa00cf527a9f0ef94566e82c918","url":"cats/paw-white.png"},{"revision":"248a63f8aff5417c4991e97b52f73013","url":"cats/professor-1.png"},{"revision":"4622de86c21f49e9ac6f46407420c0b3","url":"cats/professor-2.png"},{"revision":"9030ceda22410fae5a4a8c18bc681973","url":"cats/professor-3.png"},{"revision":"7d89614e39e2a3876445c4b40299953c","url":"cats/professor-4.png"},{"revision":"390ef056b991016e8ff15027e33f0c2f","url":"cats/professor-5.png"},{"revision":"68a66b2f4264d1ea117d6e8ff279a070","url":"cats/professor-6.png"},{"revision":"d02a15ec4727bbbacbc564103d0c412f","url":"cats/professor-head.png"},{"revision":"6aeacc15c4d410490873c0f56fbf22bb","url":"cats/sprite-1.png"},{"revision":"d8005bf11dc917d26ecd158f6dffca81","url":"cats/sprite-10.png"},{"revision":"d79380b40000c615dea51f9dfac2c506","url":"cats/sprite-11.png"},{"revision":"382fa88a45cb65597079eece4377181b","url":"cats/sprite-12.png"},{"revision":"32417dd27d6c12c8d72ce61469c2c00b","url":"cats/sprite-13.png"},{"revision":"61118984d0cb71bb64ad9a1c846a266e","url":"cats/sprite-14.png"},{"revision":"741659858b007a330f67bc714c68b546","url":"cats/sprite-15.png"},{"revision":"d959be04172c15391810593069f65c09","url":"cats/sprite-16.png"},{"revision":"045565cf476cecc2492bd30de2cada1d","url":"cats/sprite-17.png"},{"revision":"fb490597c05e74da86f3d565ec8be598","url":"cats/sprite-18.png"},{"revision":"a94a6f86b78bbc1a702b516bdc4df5bb","url":"cats/sprite-19.png"},{"revision":"84f9e1f36e8b7ece3324d45c88e33a87","url":"cats/sprite-2.png"},{"revision":"f4de1ac823a464f0f7c7a6373ba4d027","url":"cats/sprite-20.png"},{"revision":"ca4b5831df6159d481af5a67055a60ce","url":"cats/sprite-21.png"},{"revision":"286b74528cb437faa7414d50b982c1f3","url":"cats/sprite-22.png"},{"revision":"0dd4f07d1c80b0489f028a3d82aa327b","url":"cats/sprite-23.png"},{"revision":"f08f8d1f0ba37f770adc9b8f0a23603b","url":"cats/sprite-24.png"},{"revision":"4c31d40db924daa10c964a8329acd0ba","url":"cats/sprite-3.png"},{"revision":"44339585a2b82e203b769a520e638cba","url":"cats/sprite-4.png"},{"revision":"8cb21c6e53ef8f0ac6d07939e4e7ecd8","url":"cats/sprite-5.png"},{"revision":"93ff468ee14240c96c669c8c6f18196e","url":"cats/sprite-6.png"},{"revision":"a7ae94fcf465ce98788053e23693ddcb","url":"cats/sprite-7.png"},{"revision":"cebb27a6b082d3195f662ae971725173","url":"cats/sprite-8.png"},{"revision":"0759b3ba967ae9e7d8104536a7b9b706","url":"cats/sprite-9.png"},{"revision":"0f3e04204735263430f445daa2ff361a","url":"feature-graphic.png"},{"revision":"dbc8d0703319e317c21e03a943708697","url":"icons/icon-128x128.png"},{"revision":"0952c124ef3aefd69040d94069667257","url":"icons/icon-144x144.png"},{"revision":"cebbb4def58c99826b861520300101b4","url":"icons/icon-192x192.png"},{"revision":"399cdd8bac0afaf2c947f17b32b3ff97","url":"icons/icon-384x384.png"},{"revision":"4fed7b345f00a3b4bc2e1d590c06924f","url":"icons/icon-48x48.png"},{"revision":"6bbeb2ca95c722aabe645be2a658c486","url":"icons/icon-512x512.png"},{"revision":"6baff4a50d2a931e03de092af30fb721","url":"icons/icon-72x72.png"},{"revision":"1f36f2f8acaffcb4618163096efb2f9f","url":"icons/icon-96x96.png"},{"revision":"d3aff2390c8a67bcbdd3e48ea4434ed0","url":"icons/maskable-icon-128x128.png"},{"revision":"073c4211e1e092312caacb55368df5de","url":"icons/maskable-icon-144x144.png"},{"revision":"0c275e5d8add368a285a1aa90a073460","url":"icons/maskable-icon-192x192.png"},{"revision":"8843693798fd803a1c78d24274e082f3","url":"icons/maskable-icon-384x384.png"},{"revision":"69da56ffbb35fedcd638a8ca59f74e52","url":"icons/maskable-icon-48x48.png"},{"revision":"d2c14662684bed3ccf0041ac80e189fe","url":"icons/maskable-icon-512x512.png"},{"revision":"de1f127a318033e360a4dbea081cdad5","url":"icons/maskable-icon-72x72.png"},{"revision":"3a3cdf3f179463b66bfbbb99decf7ac0","url":"icons/maskable-icon-96x96.png"},{"revision":"8c3b031a11b047e393cee7ade07d2843","url":"index.html"},{"revision":"cb8d6c18a588ad99c1c10959e62769b5","url":"offline.html"},{"revision":"c726a6483f28299c446d85a00837f28b","url":"screenshots/desktop-1.png"},{"revision":"1f4d8feb6abccb77dc12a6d9de7d383a","url":"screenshots/mobile-1.png"},{"revision":"fcc1758fcdf19191d650161039c66ca4","url":"screenshots/mobile-2.png"},{"revision":"adf7a872fb97c6dad996e585e1c71423","url":"sounds/game-over.mp3"},{"revision":"2545ec32f4c6d5ed851af1e575e2c95f","url":"sounds/line-clear.mp3"},{"revision":"7bd8f1350182eb00f161fa2a9a4118c8","url":"sounds/meow.mp3"},{"revision":"e52151633186f3775e42326db21198ba","url":"themes/cat_ear_orb/32px/garbage.png"},{"revision":"bee8a6ddd355d2521409de94475027f4","url":"themes/cat_ear_orb/32px/ghost.png"},{"revision":"efba4e8ed1d6449bdf39c2ed28bdce2a","url":"themes/cat_ear_orb/32px/I.png"},{"revision":"88a088fb306de779063b8dd75439edff","url":"themes/cat_ear_orb/32px/J.png"},{"revision":"63b35c0f76cb1117e8aafa3d9c7bed23","url":"themes/cat_ear_orb/32px/L.png"},{"revision":"77ab6cb45f9ecceec5e06d639a53a635","url":"themes/cat_ear_orb/32px/O.png"},{"revision":"abbab8ac7c00c0f2a9cc2cd9889a67e0","url":"themes/cat_ear_orb/32px/S.png"},{"revision":"d063157a52bc65050c0730c676d18a57","url":"themes/cat_ear_orb/32px/T.png"},{"revision":"462d8aab7ed9d9d3677604e94d9813cf","url":"themes/cat_ear_orb/32px/Z.png"},{"revision":"9fb67eb2c9169e3b33e8c55adf856bd5","url":"themes/cat_ear_orb/preview.png"},{"revision":"bd35ed36339fb864c1b8b0ae5748b08b","url":"themes/cathead_block/32px/garbage.png"},{"revision":"07462f0178a3e35717098f6697407dee","url":"themes/cathead_block/32px/ghost.png"},{"revision":"cd136c391049e2c6d68c469aafe0bb29","url":"themes/cathead_block/32px/I.png"},{"revision":"a1a08491f8adddc555b4d8b5321f7090","url":"themes/cathead_block/32px/J.png"},{"revision":"0d6d1a24a138097be63a578017b93a41","url":"themes/cathead_block/32px/L.png"},{"revision":"27c5c00d632a80498a7f74b16ba3fece","url":"themes/cathead_block/32px/O.png"},{"revision":"1f4bef15b4e720ef03b078a87a9ed63e","url":"themes/cathead_block/32px/S.png"},{"revision":"a95551eba70de762ee26b3752070e8b6","url":"themes/cathead_block/32px/T.png"},{"revision":"1ecf97a58a5e23e99c6d1db0bf5b7d06","url":"themes/cathead_block/32px/Z.png"},{"revision":"a459647020255f746333f78369d57bec","url":"themes/cathead_block/preview.png"},{"revision":"50ef83af7023b291a55c4d75c2105b95","url":"themes/neko_badge/32px/garbage.png"},{"revision":"e92e2196667fb110597d5bf2769047aa","url":"themes/neko_badge/32px/ghost.png"},{"revision":"1d8ccaf1b6ec96777ee4b6464c491114","url":"themes/neko_badge/32px/I.png"},{"revision":"d7d04b63c41f1c8e0856c26cb1d1a662","url":"themes/neko_badge/32px/J.png"},{"revision":"c58817eb967312d46ad3781b35051e64","url":"themes/neko_badge/32px/L.png"},{"revision":"d29ec54415c3861603c437443f869149","url":"themes/neko_badge/32px/O.png"},{"revision":"a120f5e586d3ef2c8767e8f1fac76f94","url":"themes/neko_badge/32px/S.png"},{"revision":"e8b6bd13992e5e2e9aa84a8c3b06868a","url":"themes/neko_badge/32px/T.png"},{"revision":"1a26fab59eef502ac331181aaadec414","url":"themes/neko_badge/32px/Z.png"},{"revision":"0a4a336d373621f0db4a37ed42c9ad5d","url":"themes/neko_badge/preview.png"},{"revision":"51f9bd32f71834259f34e7e53589eacc","url":"cat-icon.svg"},{"revision":"cb8d6c18a588ad99c1c10959e62769b5","url":"offline.html"},{"revision":"adf7a872fb97c6dad996e585e1c71423","url":"sounds/game-over.mp3"},{"revision":"2545ec32f4c6d5ed851af1e575e2c95f","url":"sounds/line-clear.mp3"},{"revision":"7bd8f1350182eb00f161fa2a9a4118c8","url":"sounds/meow.mp3"},{"revision":"dbc8d0703319e317c21e03a943708697","url":"icons/icon-128x128.png"},{"revision":"0952c124ef3aefd69040d94069667257","url":"icons/icon-144x144.png"},{"revision":"cebbb4def58c99826b861520300101b4","url":"icons/icon-192x192.png"},{"revision":"399cdd8bac0afaf2c947f17b32b3ff97","url":"icons/icon-384x384.png"},{"revision":"4fed7b345f00a3b4bc2e1d590c06924f","url":"icons/icon-48x48.png"},{"revision":"6bbeb2ca95c722aabe645be2a658c486","url":"icons/icon-512x512.png"},{"revision":"6baff4a50d2a931e03de092af30fb721","url":"icons/icon-72x72.png"},{"revision":"1f36f2f8acaffcb4618163096efb2f9f","url":"icons/icon-96x96.png"},{"revision":"d3aff2390c8a67bcbdd3e48ea4434ed0","url":"icons/maskable-icon-128x128.png"},{"revision":"073c4211e1e092312caacb55368df5de","url":"icons/maskable-icon-144x144.png"},{"revision":"0c275e5d8add368a285a1aa90a073460","url":"icons/maskable-icon-192x192.png"},{"revision":"8843693798fd803a1c78d24274e082f3","url":"icons/maskable-icon-384x384.png"},{"revision":"69da56ffbb35fedcd638a8ca59f74e52","url":"icons/maskable-icon-48x48.png"},{"revision":"d2c14662684bed3ccf0041ac80e189fe","url":"icons/maskable-icon-512x512.png"},{"revision":"de1f127a318033e360a4dbea081cdad5","url":"icons/maskable-icon-72x72.png"},{"revision":"3a3cdf3f179463b66bfbbb99decf7ac0","url":"icons/maskable-icon-96x96.png"},{"revision":"c726a6483f28299c446d85a00837f28b","url":"screenshots/desktop-1.png"},{"revision":"1f4d8feb6abccb77dc12a6d9de7d383a","url":"screenshots/mobile-1.png"},{"revision":"fcc1758fcdf19191d650161039c66ca4","url":"screenshots/mobile-2.png"},{"revision":"dc4d2cba7569d86b8d4c0c124f8f5e9b","url":"manifest.webmanifest"}]);
Re();
C(
...
C(
  ({ url: s }) => /\.(?:mp3|wav|ogg)$/.test(s.pathname),
  new H({
    cacheName: "audio",
    plugins: [
      new Q({
...
C(
  ...
  async ({ event: s }) => {
    try {
      ...
      return e || await fetch(s.request);
    } catch {
      const e = await caches.open("offline-fallback");
      return e.match("/cat-tetris/offline.html") || e.match("/cat-tetris/index.html");
    }
  }
);
self.addEventListener("push", (s) => {
  const e = s.data ? s.data.json() : {}, t = e.title || "Cat Tetris", n = {
    body: e.body || "Hora de jogar Cat Tetris! ",
    icon: "/cat-tetris/icons/icon-192x192.png",
    badge: "/cat-tetris/icons/icon-96x96.png",
    vibrate: [100, 50, 100],
    data: {
      url: e.url || "/cat-tetris/"
    },
    actions: [
...
self.addEventListener("notificationclick", (s) => {
  ...
  const e = ((t = s.notification.data) == null ? void 0 : t.url) || "/cat-tetris/";
  s.waitUntil(
    clients.matchAll({ type: "window", includeUncontrolled: !0 }).then((n) => {
      for (const a of n)
        if (a.url.includes("/cat-tetris/") && "focus" in a)
          return a.focus();
...
self.addEventListener("sync", (s) => {
  s.tag === "sync-scores" && s.waitUntil(
    Promise.resolve()
  );
});
self.addEventListener("periodicsync", (s) => {
  s.tag === "content-sync" && s.waitUntil(
    caches.open("static-resources").then((e) => e.add("/cat-tetris/")).catch(() => {
    })
  );
});
